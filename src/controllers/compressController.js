...
// === Preset for development (local, high quality) ===
const DEV_AUTO_VARIANTS = [
  {
    label: 'master', filename: 'video_master.mp4', maxWidth: 3840, maxHeight: 2160, codec: 'libx264', profile: 'high', level: '5.1', useCRF: true, crf: 18, preset: 'slow', audioBitrate: '320k',
  },
  {
    label: 'high', filename: 'video_high.mp4', maxWidth: 1920, maxHeight: 1080, codec: 'libx264', profile: 'high', level: '4.2', videoBitrate: '8000k', maxRate: '10000k', bufSize: '16000k', preset: 'medium', audioBitrate: '192k',
  },
  {
    label: 'medium', filename: 'video_medium.mp4', maxWidth: 1280, maxHeight: 720, codec: 'libx264', profile: 'main', level: '4.0', videoBitrate: '4000k', maxRate: '6000k', bufSize: '8000k', preset: 'medium', audioBitrate: '128k',
  },
  {
    label: 'low', filename: 'video_low.mp4', maxWidth: 854, maxHeight: 480, codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '2000k', maxRate: '2500k', bufSize: '4000k', preset: 'fast', audioBitrate: '96k',
  },
];

// === Preset for production (Railway, lighter) ===
const PROD_AUTO_VARIANTS = [
  {
    label: 'master', filename: 'video_master.mp4', maxWidth: 1920, maxHeight: 1080, codec: 'libx264', profile: 'high', level: '4.2', useCRF: true, crf: 23, preset: 'medium', audioBitrate: '192k',
  },
  {
    label: 'high', filename: 'video_high.mp4', maxWidth: 1280, maxHeight: 720, codec: 'libx264', profile: 'main', level: '4.0', videoBitrate: '2500k', maxRate: '3500k', bufSize: '6000k', preset: 'fast', audioBitrate: '128k',
  },
  {
    label: 'medium', filename: 'video_medium.mp4', maxWidth: 854, maxHeight: 480, codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '1200k', maxRate: '1800k', bufSize: '3000k', preset: 'fast', audioBitrate: '96k',
  },
  {
    label: 'low', filename: 'video_low.mp4', maxWidth: 640, maxHeight: 360, codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '600k', maxRate: '900k', bufSize: '1800k', preset: 'ultrafast', audioBitrate: '64k',
  },
];

const AUTO_VARIANTS = process.env.NODE_ENV === 'production' ? PROD_AUTO_VARIANTS : DEV_AUTO_VARIANTS;
...
// === Preset for development (local, high quality) ===
const DEV_PERCENT_VARIANTS = [
  {
    label: 'master', scale: 100, filename: 'video_master.mp4', codec: 'libx264', profile: 'high', level: '5.1', useCRF: true, crf: 18, preset: 'slow', audioBitrate: '320k',
  },
  {
    label: 'high', scale: 75, filename: 'video_high.mp4', codec: 'libx264', profile: 'high', level: '4.2', videoBitrate: '8000k', maxRate: '10000k', bufSize: '16000k', preset: 'medium', audioBitrate: '192k',
  },
  {
    label: 'medium', scale: 50, filename: 'video_medium.mp4', codec: 'libx264', profile: 'main', level: '4.0', videoBitrate: '4000k', maxRate: '6000k', bufSize: '8000k', preset: 'medium', audioBitrate: '128k',
  },
  {
    label: 'low', scale: 25, filename: 'video_low.mp4', codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '2000k', maxRate: '2500k', bufSize: '4000k', preset: 'fast', audioBitrate: '96k',
  },
];

// === Preset for production (Railway, lighter) ===
const PROD_PERCENT_VARIANTS = [
  {
    label: 'master', scale: 100, filename: 'video_master.mp4', codec: 'libx264', profile: 'high', level: '4.2', useCRF: true, crf: 23, preset: 'medium', audioBitrate: '192k',
  },
  {
    label: 'high', scale: 75, filename: 'video_high.mp4', codec: 'libx264', profile: 'main', level: '4.0', videoBitrate: '2500k', maxRate: '3500k', bufSize: '6000k', preset: 'fast', audioBitrate: '128k',
  },
  {
    label: 'medium', scale: 50, filename: 'video_medium.mp4', codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '1200k', maxRate: '1800k', bufSize: '3000k', preset: 'fast', audioBitrate: '96k',
  },
  {
    label: 'low', scale: 25, filename: 'video_low.mp4', codec: 'libx264', profile: 'baseline', level: '3.0', videoBitrate: '600k', maxRate: '900k', bufSize: '1800k', preset: 'ultrafast', audioBitrate: '64k',
  },
];

const PERCENT_VARIANTS = process.env.NODE_ENV === 'production' ? PROD_PERCENT_VARIANTS : DEV_PERCENT_VARIANTS;
